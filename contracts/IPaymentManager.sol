...
interface IPaymentManager {
    ...
    function addNewAdminToken(address _token, address _function, uint256 _fee, string memory _funtionName) external returns (bool);
    ...
    function setAdminTokenFee(address _token, address _function, uint256 _fee, string memory _funtionName) external returns (bool);
